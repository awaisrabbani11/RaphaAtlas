...
<div class="flex justify-between items-center px-4 md:px-8 py-2 w-full max-w-7xl mx-auto">
  ...
  <nav class="hidden lg:flex items-center space-x-6">
    ...
    <div class="relative group">
      <button class="flex items-center space-x-1 text-on-primary font-bold hover:text-vitality-teal transition-colors py-2" style="font-family: 'Inter', sans-serif;" aria-expanded="false">
  ...
  <div class="flex items-center space-x-4">
    <button class="lg:hidden text-on-primary" id="mobile-menu-btn" aria-label="Toggle mobile menu">
...
<div id="mobile-menu" class="fixed inset-y-0 right-0 w-64 bg-surface-container-lowest shadow-2xl z-[100] transform translate-x-full transition-transform duration-300 lg:hidden overflow-y-auto border-l border-border-subtle">
  ...
  <nav class="p-4 flex flex-col space-y-2">
    ...
    <div class="py-2 border-b border-border-subtle">
      <button class="flex items-center justify-between w-full text-primary font-bold mb-2 mobile-dropdown-btn">
        <span>Calculators</span>
        <span class="material-symbols-outlined text-sm transition-transform duration-200">expand_more</span>
      </button>
      <div class="pl-4 space-y-2 mobile-dropdown-content overflow-hidden max-h-0 transition-all duration-300">
        <a href="/bac-calculator" class="block text-on-surface-variant hover:text-primary py-1">BAC Calculator</a>
        <a href="/body-type-calculator" class="block text-on-surface-variant hover:text-primary py-1">Body Type Calculator</a>
        <a href="/macro-calculator" class="block text-on-surface-variant hover:text-primary py-1">Macro Calculator</a>
        <a href="/conception-calculator" class="block text-on-surface-variant hover:text-primary py-1">Conception Calculator</a>
        <a href="/calculators" class="block text-on-surface-variant hover:text-primary py-1">All Calculators</a>
      </div>
    </div>
    ...
    <div class="py-2 border-b border-border-subtle">
      ...
      <div class="pl-4 space-y-2 mobile-dropdown-content overflow-hidden max-h-0 transition-all duration-300">
        <a href="/about" class="block text-on-surface-variant hover:text-primary py-1">About Us</a>
        <a href="/editorial-policy" class="block text-on-surface-variant hover:text-primary py-1">Editorial Policy</a>
        <a href="/medical-review-board" class="block text-on-surface-variant hover:text-primary py-1">Medical Review Board</a>
        <a href="/privacy" class="block text-on-surface-variant hover:text-primary py-1">Privacy Policy</a>
        <a href="/contact" class="block text-on-surface-variant hover:text-primary py-1">Contact Us</a>
      </div>
    </div>
  </nav>
</div>
...
for (const file of files) {
  ...
  content = content.replace(/<header[^>]*>.*?<\/header>/s, newHeader);
